...
# Carosello
  ...
  ## Fase Preliminare
  - Creare il markup in html.
  - Collegare JS al DOM.
  - Creare un array `images` contenente gli indirizzi delle immagini.
  - Creare una variabile `active` che indicherà l'immagine in posizione `0` dell'array.

  ## Fase Svolgimento
  - **AL CLICK** della freccia DX
    - Selezionare l'immagine successiva cambiando la "posizione indice" della variabile `active` aumentandola di `1`.
    - Aggiungere l'html in pagina